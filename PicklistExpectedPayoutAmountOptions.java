...
public class PicklistExpectedPayoutAmountOptions {
     ...
     * This is why there is not a {@code set} method for the expectedPayoutAmount property.
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the expectedPayoutAmount property.
     */
    public List<Long> getExpectedPayoutAmount() {
        if (expectedPayoutAmount == null) {
            expectedPayoutAmount = new ArrayList<>();
        }
