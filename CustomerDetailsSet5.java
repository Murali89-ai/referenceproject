...
public class CustomerDetailsSet5 {
  ...
  public CustomerDetailsSet5() {
  }

  public CustomerDetailsSet5 customerSequenceNo(Integer customerSequenceNo) {
  ...
  **/
  ...
  public CustomerDetailsSet5 customerPersonalInfo(CustomerAndAudit customerPersonalInfo) {
  ...
  **/
  ...
  public CustomerDetailsSet5 customerAccountInfo(List<AccountAndAudit> customerAccountInfo) {
    
    this.customerAccountInfo = customerAccountInfo;
    return this;
  }

  public CustomerDetailsSet5 addCustomerAccountInfoItem(AccountAndAudit customerAccountInfoItem) {
  ...
  **/
  ...
  public CustomerDetailsSet5 customerAccountOnboardingInfo(List<AccountOnboardingAndAudit> customerAccountOnboardingInfo) {
    
    this.customerAccountOnboardingInfo = customerAccountOnboardingInfo;
    return this;
  }

  public CustomerDetailsSet5 addCustomerAccountOnboardingInfoItem(AccountOnboardingAndAudit customerAccountOnboardingInfoItem) {
  ...
  **/
  ...
  public CustomerDetailsSet5 customerAddress(List<AddressAndAudit> customerAddress) {
    
    this.customerAddress = customerAddress;
    return this;
  }

  public CustomerDetailsSet5 addCustomerAddressItem(AddressAndAudit customerAddressItem) {
  ...
  **/
  ...
  public CustomerDetailsSet5 customerEmail(List<EmailAndAudit> customerEmail) {
    
    this.customerEmail = customerEmail;
    return this;
  }

  public CustomerDetailsSet5 addCustomerEmailItem(EmailAndAudit customerEmailItem) {
  ...
  **/
  ...
  public CustomerDetailsSet5 customerPhone(List<PhoneAndAudit> customerPhone) {
    
    this.customerPhone = customerPhone;
    return this;
  }

  public CustomerDetailsSet5 addCustomerPhoneItem(PhoneAndAudit customerPhoneItem) {
  ...
  **/
  ...
  public CustomerDetailsSet5 customerSecurity(List<SecurityQueAndAnsAndAudit> customerSecurity) {
    
    this.customerSecurity = customerSecurity;
    return this;
  }

  public CustomerDetailsSet5 addCustomerSecurityItem(SecurityQueAndAnsAndAudit customerSecurityItem) {
  ...
  **/
  ...
  public CustomerDetailsSet5 customerPreferences(PreferencesAndAudit customerPreferences) {
  ...
  **/
  ...
  public CustomerDetailsSet5 customerFundingSources(List<FundingSourceAndAudit> customerFundingSources) {
    
    this.customerFundingSources = customerFundingSources;
    return this;
  }

  public CustomerDetailsSet5 addCustomerFundingSourcesItem(FundingSourceAndAudit customerFundingSourcesItem) {
  ...
  **/
  ...
  public CustomerDetailsSet5 customerKyc(List<KycAndAudit> customerKyc) {
    
    this.customerKyc = customerKyc;
    return this;
  }

  public CustomerDetailsSet5 addCustomerKycItem(KycAndAudit customerKycItem) {
  ...
  **/
  ...
  public CustomerDetailsSet5 customerKycDetails(List<CustomerKycDetailAndAudit> customerKycDetails) {
    
    this.customerKycDetails = customerKycDetails;
    return this;
  }

  public CustomerDetailsSet5 addCustomerKycDetailsItem(CustomerKycDetailAndAudit customerKycDetailsItem) {
  ...
  **/
  ...
  public CustomerDetailsSet5 customerVerificationDetails(List<CustomerVerificationDetailAndAudit> customerVerificationDetails) {
    
    this.customerVerificationDetails = customerVerificationDetails;
    return this;
  }

  public CustomerDetailsSet5 addCustomerVerificationDetailsItem(CustomerVerificationDetailAndAudit customerVerificationDetailsItem) {
  ...
  **/
  ...
  public CustomerDetailsSet5 customerReceivers(List<CustomerReceiverAndAudit> customerReceivers) {
    
    this.customerReceivers = customerReceivers;
    return this;
  }

  public CustomerDetailsSet5 addCustomerReceiversItem(CustomerReceiverAndAudit customerReceiversItem) {
  ...
  **/
  ...
  public CustomerDetailsSet5 customerUab(List<UabAndAudit> customerUab) {
    
    this.customerUab = customerUab;
    return this;
  }

  public CustomerDetailsSet5 addCustomerUabItem(UabAndAudit customerUabItem) {
  ...
  **/
  ...
  public CustomerDetailsSet5 customerUsageStatistics(CustomerUsageStatisticsAndAudit customerUsageStatistics) {
  ...
  **/
  ...
  public CustomerDetailsSet5 customerPartner(CustomerPartnerAndAudit customerPartner) {
  ...
  **/
  ...
  public CustomerDetailsSet5 customerAccountRepresentative(List<CustomerAccountRepresentativeAndAudit> customerAccountRepresentative) {
    
    this.customerAccountRepresentative = customerAccountRepresentative;
    return this;
  }

  public CustomerDetailsSet5 addCustomerAccountRepresentativeItem(CustomerAccountRepresentativeAndAudit customerAccountRepresentativeItem) {
  ...
  **/
  ...
  public CustomerDetailsSet5 customerServiceProvider(List<CustomerServiceProviderAndAudit> customerServiceProvider) {
    
    this.customerServiceProvider = customerServiceProvider;
    return this;
  }

  public CustomerDetailsSet5 addCustomerServiceProviderItem(CustomerServiceProviderAndAudit customerServiceProviderItem) {
  ...
  **/
  ...
  public CustomerDetailsSet5 customerMiscFlags(List<CustomerMiscFlagsAndAudit> customerMiscFlags) {
    
    this.customerMiscFlags = customerMiscFlags;
    return this;
  }

  public CustomerDetailsSet5 addCustomerMiscFlagsItem(CustomerMiscFlagsAndAudit customerMiscFlagsItem) {
  ...
  **/
  ...
  public CustomerDetailsSet5 profileAttributes(ProfileAttributesAndAudit profileAttributes) {
  ...
  **/
  ...
  public CustomerDetailsSet5 prepaid(PrepaidAndAudit prepaid) {
  ...
  **/
  ...
  public CustomerDetailsSet5 segmentationCodes(SegmentationCodesAndAudit segmentationCodes) {
  ...
  **/
  ...
  public CustomerDetailsSet5 pepProfileEntities(PepProfileEntitiesAndAudit pepProfileEntities) {
  ...
  **/
  ...
  public CustomerDetailsSet5 ucbDisplayFlag(UcbDisplayFlagAndAudit ucbDisplayFlag) {
  ...
  **/
  ...
  public CustomerDetailsSet5 doNotDisplay(Boolean doNotDisplay) {
  ...
  **/
  ...
  public CustomerDetailsSet5 isConvenience(Boolean isConvenience) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    CustomerDetailsSet5 customerDetailsSet5 = (CustomerDetailsSet5) o;
    return Objects.equals(this.customerSequenceNo, customerDetailsSet5.customerSequenceNo) &&
        Objects.equals(this.customerPersonalInfo, customerDetailsSet5.customerPersonalInfo) &&
        Objects.equals(this.customerAccountInfo, customerDetailsSet5.customerAccountInfo) &&
        Objects.equals(this.customerAccountOnboardingInfo, customerDetailsSet5.customerAccountOnboardingInfo) &&
        Objects.equals(this.customerAddress, customerDetailsSet5.customerAddress) &&
        Objects.equals(this.customerEmail, customerDetailsSet5.customerEmail) &&
        Objects.equals(this.customerPhone, customerDetailsSet5.customerPhone) &&
        Objects.equals(this.customerSecurity, customerDetailsSet5.customerSecurity) &&
        Objects.equals(this.customerPreferences, customerDetailsSet5.customerPreferences) &&
        Objects.equals(this.customerFundingSources, customerDetailsSet5.customerFundingSources) &&
        Objects.equals(this.customerKyc, customerDetailsSet5.customerKyc) &&
        Objects.equals(this.customerKycDetails, customerDetailsSet5.customerKycDetails) &&
        Objects.equals(this.customerVerificationDetails, customerDetailsSet5.customerVerificationDetails) &&
        Objects.equals(this.customerReceivers, customerDetailsSet5.customerReceivers) &&
        Objects.equals(this.customerUab, customerDetailsSet5.customerUab) &&
        Objects.equals(this.customerUsageStatistics, customerDetailsSet5.customerUsageStatistics) &&
        Objects.equals(this.customerPartner, customerDetailsSet5.customerPartner) &&
        Objects.equals(this.customerAccountRepresentative, customerDetailsSet5.customerAccountRepresentative) &&
        Objects.equals(this.customerServiceProvider, customerDetailsSet5.customerServiceProvider) &&
        Objects.equals(this.customerMiscFlags, customerDetailsSet5.customerMiscFlags) &&
        Objects.equals(this.profileAttributes, customerDetailsSet5.profileAttributes) &&
        Objects.equals(this.prepaid, customerDetailsSet5.prepaid) &&
        Objects.equals(this.segmentationCodes, customerDetailsSet5.segmentationCodes) &&
        Objects.equals(this.pepProfileEntities, customerDetailsSet5.pepProfileEntities) &&
        Objects.equals(this.ucbDisplayFlag, customerDetailsSet5.ucbDisplayFlag) &&
        Objects.equals(this.doNotDisplay, customerDetailsSet5.doNotDisplay) &&
        Objects.equals(this.isConvenience, customerDetailsSet5.isConvenience);
  }

  @Override
  public int hashCode() {
    return Objects.hash(customerSequenceNo, customerPersonalInfo, customerAccountInfo, customerAccountOnboardingInfo, customerAddress, customerEmail, customerPhone, customerSecurity, customerPreferences, customerFundingSources, customerKyc, customerKycDetails, customerVerificationDetails, customerReceivers, customerUab, customerUsageStatistics, customerPartner, customerAccountRepresentative, customerServiceProvider, customerMiscFlags, profileAttributes, prepaid, segmentationCodes, pepProfileEntities, ucbDisplayFlag, doNotDisplay, isConvenience);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CustomerDetailsSet5 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CustomerDetailsSet5
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CustomerDetailsSet5.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CustomerDetailsSet5 is not found in the empty JSON string", CustomerDetailsSet5.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!CustomerDetailsSet5.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CustomerDetailsSet5` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CustomerDetailsSet5.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CustomerDetailsSet5' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CustomerDetailsSet5> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CustomerDetailsSet5.class));

       return (TypeAdapter<T>) new TypeAdapter<CustomerDetailsSet5>() {
           @Override
           public void write(JsonWriter out, CustomerDetailsSet5 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CustomerDetailsSet5 read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of CustomerDetailsSet5 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CustomerDetailsSet5
  * @throws IOException if the JSON string is invalid with respect to CustomerDetailsSet5
  */
  public static CustomerDetailsSet5 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CustomerDetailsSet5.class);
  }

 /**
  * Convert an instance of CustomerDetailsSet5 to an JSON string
  *
  * @return JSON string
  */
