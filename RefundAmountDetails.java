...
@XmlType(name = "refund_amount_details", propOrder = {
    "refundAmount"
})
public class RefundAmountDetails {
     ...
     * This is why there is not a {@code set} method for the refundAmount property.
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the refundAmount property.
     */
