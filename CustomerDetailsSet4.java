...
public class CustomerDetailsSet4 {
  ...
  public CustomerDetailsSet4() {
  }

  public CustomerDetailsSet4 customerSequenceNo(Integer customerSequenceNo) {
  ...
  **/
  ...
  public CustomerDetailsSet4 customerPersonalInfo(CustomerAndAudit customerPersonalInfo) {
  ...
  **/
  ...
  public CustomerDetailsSet4 customerAccountInfo(List<AccountAndAudit> customerAccountInfo) {
    
    this.customerAccountInfo = customerAccountInfo;
    return this;
  }

  public CustomerDetailsSet4 addCustomerAccountInfoItem(AccountAndAudit customerAccountInfoItem) {
  ...
  **/
  ...
  public CustomerDetailsSet4 customerAccountOnboardingInfo(List<AccountOnboardingAndAudit> customerAccountOnboardingInfo) {
    
    this.customerAccountOnboardingInfo = customerAccountOnboardingInfo;
    return this;
  }

  public CustomerDetailsSet4 addCustomerAccountOnboardingInfoItem(AccountOnboardingAndAudit customerAccountOnboardingInfoItem) {
  ...
  **/
  ...
  public CustomerDetailsSet4 customerAddress(List<AddressAndAudit> customerAddress) {
    
    this.customerAddress = customerAddress;
    return this;
  }

  public CustomerDetailsSet4 addCustomerAddressItem(AddressAndAudit customerAddressItem) {
  ...
  **/
  ...
  public CustomerDetailsSet4 customerEmail(List<EmailAndAudit> customerEmail) {
    
    this.customerEmail = customerEmail;
    return this;
  }

  public CustomerDetailsSet4 addCustomerEmailItem(EmailAndAudit customerEmailItem) {
  ...
  **/
  ...
  public CustomerDetailsSet4 customerPhone(List<PhoneAndAudit> customerPhone) {
    
    this.customerPhone = customerPhone;
    return this;
  }

  public CustomerDetailsSet4 addCustomerPhoneItem(PhoneAndAudit customerPhoneItem) {
  ...
  **/
  ...
  public CustomerDetailsSet4 customerSecurity(List<SecurityQueAndAnsAndAudit> customerSecurity) {
    
    this.customerSecurity = customerSecurity;
    return this;
  }

  public CustomerDetailsSet4 addCustomerSecurityItem(SecurityQueAndAnsAndAudit customerSecurityItem) {
  ...
  **/
  ...
  public CustomerDetailsSet4 customerPreferences(PreferencesAndAudit customerPreferences) {
  ...
  **/
  ...
  public CustomerDetailsSet4 customerFundingSources(List<FundingSourceAndAudit> customerFundingSources) {
    
    this.customerFundingSources = customerFundingSources;
    return this;
  }

  public CustomerDetailsSet4 addCustomerFundingSourcesItem(FundingSourceAndAudit customerFundingSourcesItem) {
  ...
  **/
  ...
  public CustomerDetailsSet4 customerKyc(List<KycAndAudit> customerKyc) {
    
    this.customerKyc = customerKyc;
    return this;
  }

  public CustomerDetailsSet4 addCustomerKycItem(KycAndAudit customerKycItem) {
  ...
  **/
  ...
  public CustomerDetailsSet4 customerKycDetails(List<CustomerKycDetailAndAudit> customerKycDetails) {
    
    this.customerKycDetails = customerKycDetails;
    return this;
  }

  public CustomerDetailsSet4 addCustomerKycDetailsItem(CustomerKycDetailAndAudit customerKycDetailsItem) {
  ...
  **/
  ...
  public CustomerDetailsSet4 customerVerificationDetails(List<CustomerVerificationDetailAndAudit> customerVerificationDetails) {
    
    this.customerVerificationDetails = customerVerificationDetails;
    return this;
  }

  public CustomerDetailsSet4 addCustomerVerificationDetailsItem(CustomerVerificationDetailAndAudit customerVerificationDetailsItem) {
  ...
  **/
  ...
  public CustomerDetailsSet4 customerReceivers(List<CustomerReceiverAndAudit> customerReceivers) {
    
    this.customerReceivers = customerReceivers;
    return this;
  }

  public CustomerDetailsSet4 addCustomerReceiversItem(CustomerReceiverAndAudit customerReceiversItem) {
  ...
  **/
  ...
  public CustomerDetailsSet4 customerUab(List<UabAndAudit> customerUab) {
    
    this.customerUab = customerUab;
    return this;
  }

  public CustomerDetailsSet4 addCustomerUabItem(UabAndAudit customerUabItem) {
  ...
  **/
  ...
  public CustomerDetailsSet4 customerUsageStatistics(CustomerUsageStatisticsAndAudit customerUsageStatistics) {
  ...
  **/
  ...
  public CustomerDetailsSet4 customerPartner(CustomerPartnerAndAudit customerPartner) {
  ...
  **/
  ...
  public CustomerDetailsSet4 customerAccountRepresentative(List<CustomerAccountRepresentativeAndAudit> customerAccountRepresentative) {
    
    this.customerAccountRepresentative = customerAccountRepresentative;
    return this;
  }

  public CustomerDetailsSet4 addCustomerAccountRepresentativeItem(CustomerAccountRepresentativeAndAudit customerAccountRepresentativeItem) {
  ...
  **/
  ...
  public CustomerDetailsSet4 customerServiceProvider(List<CustomerServiceProviderAndAudit> customerServiceProvider) {
    
    this.customerServiceProvider = customerServiceProvider;
    return this;
  }

  public CustomerDetailsSet4 addCustomerServiceProviderItem(CustomerServiceProviderAndAudit customerServiceProviderItem) {
  ...
  **/
  ...
  public CustomerDetailsSet4 customerMiscFlags(List<CustomerMiscFlagsAndAudit> customerMiscFlags) {
    
    this.customerMiscFlags = customerMiscFlags;
    return this;
  }

  public CustomerDetailsSet4 addCustomerMiscFlagsItem(CustomerMiscFlagsAndAudit customerMiscFlagsItem) {
  ...
  **/
  ...
  public CustomerDetailsSet4 profileAttributes(ProfileAttributesAndAudit profileAttributes) {
  ...
  **/
  ...
  public CustomerDetailsSet4 customerRole(CustomerRoleAndAudit customerRole) {
  ...
  **/
  ...
  public CustomerDetailsSet4 prepaid(PrepaidAndAudit prepaid) {
  ...
  **/
  ...
  public CustomerDetailsSet4 segmentationCodes(SegmentationCodesAndAudit segmentationCodes) {
  ...
  **/
  ...
  public CustomerDetailsSet4 pepProfileEntities(PepProfileEntitiesAndAudit pepProfileEntities) {
  ...
  **/
  ...
  public CustomerDetailsSet4 ucbDisplayFlag(UcbDisplayFlagAndAudit ucbDisplayFlag) {
  ...
  **/
  ...
  public CustomerDetailsSet4 notificationStatus(String notificationStatus) {
  ...
  **/
  ...
  public CustomerDetailsSet4 doNotDisplay(Boolean doNotDisplay) {
  ...
  **/
  ...
  public CustomerDetailsSet4 isConvenience(Boolean isConvenience) {
  ...
  **/
  ...
  public CustomerDetailsSet4 createdSync(String createdSync) {
  ...
  **/
  ...
  public CustomerDetailsSet4 updatedSync(String updatedSync) {
  ...
  **/
  ...
  public CustomerDetailsSet4 nextStartIndex(Integer nextStartIndex) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    CustomerDetailsSet4 customerDetailsSet4 = (CustomerDetailsSet4) o;
    return Objects.equals(this.customerSequenceNo, customerDetailsSet4.customerSequenceNo) &&
        Objects.equals(this.customerPersonalInfo, customerDetailsSet4.customerPersonalInfo) &&
        Objects.equals(this.customerAccountInfo, customerDetailsSet4.customerAccountInfo) &&
        Objects.equals(this.customerAccountOnboardingInfo, customerDetailsSet4.customerAccountOnboardingInfo) &&
        Objects.equals(this.customerAddress, customerDetailsSet4.customerAddress) &&
        Objects.equals(this.customerEmail, customerDetailsSet4.customerEmail) &&
        Objects.equals(this.customerPhone, customerDetailsSet4.customerPhone) &&
        Objects.equals(this.customerSecurity, customerDetailsSet4.customerSecurity) &&
        Objects.equals(this.customerPreferences, customerDetailsSet4.customerPreferences) &&
        Objects.equals(this.customerFundingSources, customerDetailsSet4.customerFundingSources) &&
        Objects.equals(this.customerKyc, customerDetailsSet4.customerKyc) &&
        Objects.equals(this.customerKycDetails, customerDetailsSet4.customerKycDetails) &&
        Objects.equals(this.customerVerificationDetails, customerDetailsSet4.customerVerificationDetails) &&
        Objects.equals(this.customerReceivers, customerDetailsSet4.customerReceivers) &&
        Objects.equals(this.customerUab, customerDetailsSet4.customerUab) &&
        Objects.equals(this.customerUsageStatistics, customerDetailsSet4.customerUsageStatistics) &&
        Objects.equals(this.customerPartner, customerDetailsSet4.customerPartner) &&
        Objects.equals(this.customerAccountRepresentative, customerDetailsSet4.customerAccountRepresentative) &&
        Objects.equals(this.customerServiceProvider, customerDetailsSet4.customerServiceProvider) &&
        Objects.equals(this.customerMiscFlags, customerDetailsSet4.customerMiscFlags) &&
        Objects.equals(this.profileAttributes, customerDetailsSet4.profileAttributes) &&
        Objects.equals(this.customerRole, customerDetailsSet4.customerRole) &&
        Objects.equals(this.prepaid, customerDetailsSet4.prepaid) &&
        Objects.equals(this.segmentationCodes, customerDetailsSet4.segmentationCodes) &&
        Objects.equals(this.pepProfileEntities, customerDetailsSet4.pepProfileEntities) &&
        Objects.equals(this.ucbDisplayFlag, customerDetailsSet4.ucbDisplayFlag) &&
        Objects.equals(this.notificationStatus, customerDetailsSet4.notificationStatus) &&
        Objects.equals(this.doNotDisplay, customerDetailsSet4.doNotDisplay) &&
        Objects.equals(this.isConvenience, customerDetailsSet4.isConvenience) &&
        Objects.equals(this.createdSync, customerDetailsSet4.createdSync) &&
        Objects.equals(this.updatedSync, customerDetailsSet4.updatedSync) &&
        Objects.equals(this.nextStartIndex, customerDetailsSet4.nextStartIndex);
  }

  @Override
  public int hashCode() {
    return Objects.hash(customerSequenceNo, customerPersonalInfo, customerAccountInfo, customerAccountOnboardingInfo, customerAddress, customerEmail, customerPhone, customerSecurity, customerPreferences, customerFundingSources, customerKyc, customerKycDetails, customerVerificationDetails, customerReceivers, customerUab, customerUsageStatistics, customerPartner, customerAccountRepresentative, customerServiceProvider, customerMiscFlags, profileAttributes, customerRole, prepaid, segmentationCodes, pepProfileEntities, ucbDisplayFlag, notificationStatus, doNotDisplay, isConvenience, createdSync, updatedSync, nextStartIndex);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CustomerDetailsSet4 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CustomerDetailsSet4
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CustomerDetailsSet4.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CustomerDetailsSet4 is not found in the empty JSON string", CustomerDetailsSet4.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!CustomerDetailsSet4.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CustomerDetailsSet4` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CustomerDetailsSet4.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CustomerDetailsSet4' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CustomerDetailsSet4> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CustomerDetailsSet4.class));

       return (TypeAdapter<T>) new TypeAdapter<CustomerDetailsSet4>() {
           @Override
           public void write(JsonWriter out, CustomerDetailsSet4 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CustomerDetailsSet4 read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of CustomerDetailsSet4 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CustomerDetailsSet4
  * @throws IOException if the JSON string is invalid with respect to CustomerDetailsSet4
  */
  public static CustomerDetailsSet4 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CustomerDetailsSet4.class);
  }

 /**
  * Convert an instance of CustomerDetailsSet4 to an JSON string
  *
  * @return JSON string
  */
