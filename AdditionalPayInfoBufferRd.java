...
/**
 * <p>Java class for additional_pay_info_buffer_rd complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>{@code
 * <complexType name="additional_pay_info_buffer_rd">
 *   <complexContent>
 *     <restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       <sequence>
 *         <element name="buffer_data" type="{http://www.westernunion.com/schema/xrsi}popup_buffer" minOccurs="0"/>
 *         <element name="payment_info" type="{http://www.westernunion.com/schema/xrsi}payment_info_rd" maxOccurs="10" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
@XmlType(name = "additional_pay_info_buffer_rd", propOrder = {
    "bufferData",
    "paymentInfo"
})
public class AdditionalPayInfoBufferRd {

    @XmlElement(name = "buffer_data")
    protected String bufferData;
    @XmlElement(name = "payment_info")
    protected List<PaymentInfoRd> paymentInfo;
     ...
     */
    public List<PaymentInfoRd> getPaymentInfo() {
        if (paymentInfo == null) {
